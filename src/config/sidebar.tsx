...
export const VENDEDOR_SideBar: NavItem[] = [
    { id: 'dashboard',    label: 'Dashboard',    href: '/ventas/dashboard',                icon: <FaHome /> },
    { id: 'cot',          label: 'Cotizaciones', href: '/ventas/cotizaciones',             icon: <FaClipboardList /> },
    { id: 'ventas',       label: 'Ventas',       href: '/ventas/ventas',                   icon: <FaShoppingCart /> },
    { id: 'clientes',     label: 'Clientes',     href: '/ventas/clientes',                 icon: <FaUsers /> },
    { id: 'inv',          label: 'Inventario',   href: '/ventas/inventario',               icon: <FaBoxes /> },
];
